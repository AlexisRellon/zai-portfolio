    ...
    <div class="container mx-auto px-4 md:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="text-center md:text-left">
          <h2 class="text-2xl font-bold mb-2">ZAI</h2>
          <p class="text-background/80">Political Science Graduate & Tech Enthusiast</p>
        </div>
      ...
      <div class="border-t border-background/20 mt-8 pt-8 flex flex-col md:flex-row gap-4 justify-between items-center">
        <p class="text-background/70 text-sm">
          &copy; {{ new Date().getFullYear() }} Zhyron Wynriel Alimon. All rights reserved.
        </p>
...
const LinkedInIcon = {
  template: `<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
